...
request = (http_post_string("http://pastebin.com/api/api_login.php",str));
...
format - The syntax highlighting for this paste - More detail: http://pastebin.com/api#5
privacy - The privacy of the paste - 0 for Public, 1 for Unlisted, 2 for Private (requires login)
expire - When this paste will expire - More detail: http://pastebin.com/api#6
[userkey] - A userkey for the account you wish to tie the paste to - *Optional*
*/


var code, name, format, privacy, expire, userkey, str;
